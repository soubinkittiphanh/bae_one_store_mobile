...
import 'cart_oview_comp.dart';

class CustomerInfoComp extends StatefulWidget {
  final double cartTotalPrice;
  const CustomerInfoComp({Key? key, required this.cartTotalPrice})
      : super(key: key);

  @override
  State<CustomerInfoComp> createState() => _CustomerInfoCompState();
}

class _CustomerInfoCompState extends State<CustomerInfoComp> {
